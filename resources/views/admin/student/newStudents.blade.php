    ...
    <main>
        <x-main-content>
            ...
            <div class="border border-blue-300 p-2 bg-blue-200 text-blue-700">
                <p class="text-sm font-bold">List of all newly registered students.</p>
            </div>
                                        ...
                                        @foreach ($students as $item)
                                            <tr class="border-b dark:border-neutral-500">
                                                ...
                                                <td class="whitespace-nowrap px-6 py-1 text-center">
                                                    {{-- <a href="#"> --}}
                                                    <button
                                                        class="activeStudent border border-green-300 font-bold text-xs bg-green-200 text-green-500 px-3"
                                                        data-id="{{ $item->id }}">
                                                        Activate
                                                    </button>
                                                    {{-- </a> --}}
