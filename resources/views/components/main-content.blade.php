    ...
    <dh-component>
        <div class="flex flex-no-wrap">
            <div style="min-height: 100vh;"
                class="absolute sm:relative bg-slate-100 md:h-full flex-col justify-between hidden sm:flex">
                <div class="px-8">
            ...
            <div class="container border-s border-slate-300 min-h-screen mx-auto p-1 md:p-4 md:w-8/12 lg:w-10/12">
