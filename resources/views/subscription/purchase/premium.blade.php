    ...
    <div class="container mx-auto min-h-screen border bg-white p-4">
        <div class="flex flex-wrap justify-between items-start">
            <div class="w-full border rounded-md border-slate-200 my-2 p-2 md:w-[65%] md:p-2">
                ...
                <form
                    action="{{ URL::temporarySignedRoute('plan.store.premium', now()->addMinutes(60), ['user' => Auth::user()->name, 'email' => Auth::user()->email]) }}"
                        ...
                        <div class="md:flex">
                            ...
                            <div class="w-full md:w-2/3">
                                <select name="plan_code" id="plan_code"
                                    ...
                                    <option value="{{ $plan['plan_code'] }}">Premium Plan</option>
                                </select>
                                @error('plan_code')
