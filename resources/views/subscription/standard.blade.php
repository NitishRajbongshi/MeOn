...
@section('content')
    ...
    <div class="container mx-auto min-h-screen">
        ...
        <div class="flex flex-wrap justify-between items-start">
            <div class="w-full border rounded-md border-slate-200 my-2 p-2 md:w-[65%] md:p-2">
                ...
                <form
                    action="{{ URL::temporarySignedRoute('plan.purchase.standard', now()->addMinutes(60), ['user' => Auth::user()->name, 'email' => Auth::user()->email]) }}"
                    method="post" autocomplete="off">
                    @csrf
                    <fieldset class="my-3">
                        <input type="hidden" id="plan_input" name="plan_code" value="2">
            ...
            <div class="w-full border rounded-md border-slate-200 my-2 p-2 md:w-[34.5%] md:p-2">
                ...
                <div>
                    <h1>Subject Name: <span id="subject_name">NULL</span></h1>
                    <h1>Descrption: <span id="subject_description">NULL</span></h1>
                    <div>
                        <h1>Actual Price
    ...
    @push('scripts')
    <script src="{{ asset('js/subscription/standard.js') }}" defer></script>
@endpush
@endsection
